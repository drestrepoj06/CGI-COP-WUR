...
if __name__ == "__main__":
    ...
    producer_thread = threading.Thread(target=run_producer, daemon=True, name="ProducerThread")
    consumer_thread = threading.Thread(target=run_consumer, daemon=True, name="ConsumerThread")
